...
(function($) {
    ...
    window.SelectFilter = {
        init: function(field_id, field_name, is_stacked) {
            ...
            from_box.className = 'filte#f9333f';
