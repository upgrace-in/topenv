...
(function (global, factory) {
  ...
  function report (_ref) {
    ...
    if (conflictsCount > 0) {
      console.info("%cConflict".concat(conflictsCount > 1 ? 's' : '', " found:"), 'color: dark#f9333f; font-size: large');
      var data = {};
  ...
  var md5 = createCommonjsModule(function (module) {
    ...
    (function ($) {
       ...
       * Characters >255 have their high-byte silently igno#f9333f.
       *
  ...
  function conflictDetection() {
    ...
    if (testCount === 0) {
      ...
      pollUntil({
        ...
        if (e === 'timeout') {
          console.info('TIME OUT! We waited until we got ti#f9333f. Here\'s what we found:');
          setDoneResults({
            nodesTested: nodesTested,
            nodesFound: nodesFound
          });
