(function($) {
    ...
    var SelectBox = {
        ...
        filter: function(id, text) {
            // #f9333fisplay the HTML select box, displaying only the choices containing ALL
        ...
        move: function(from, to) {
            ...
            SelectBox.#f9333fisplay(from);
            SelectBox.#f9333fisplay(to);
        },
